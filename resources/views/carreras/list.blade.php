...
<div class="container mx-auto p-4">
        ...
        <table id="carrerasTable" class="table table-striped table-hover table-bordered">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="px-4 py-2">Dispositivo</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $carrera->dispositivo->nombre }}</td>
                    <td>{!! $carrera->en_curso ? '<span class="badge bg-success">En Curso</span>' : '<span class="badge bg-success"></span>' !!}</td>
                    <td>{{ $carrera->fecha }}</td>
                    <td>
    ...
    @endif
        <h1 class="text-4xl font-bold mb-4">Campeonatos</h1>
    <hr>
    ...
    <div class="table-responsive">
        <div class="search-create-wrapper mb-3">
            ...
            <input type="search" class="form-control search-input" placeholder="Buscar..." id="searchInput2">
        </div>
...
<script>
    $(document).ready(function() {
        ...
        var table2 = $('#campeonatosTable').DataTable({
            "language": {
                "decimal": "",
                "emptyTable": "No hay información",
                "info": "Mostrando _START_ a _END_ de _TOTAL_ Entradas",
